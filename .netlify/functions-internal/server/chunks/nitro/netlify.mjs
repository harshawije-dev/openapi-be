...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\documents\\Builds 2024 New\\API\\openapi-be\\.data\\kv"}));
...
const _lazy_F4H4t8 = () => import('../message.get.mjs');
const _lazy_tboQFb = () => import('../prompt.post.mjs');
const _lazy_pj9sNu = () => import('../security.get.mjs');
const _lazy_9m0S0k = () => import('../index.mjs');

const handlers = [
  { route: '/api/message', handler: _lazy_F4H4t8, lazy: true, middleware: false, method: "get" },
  { route: '/api/prompt', handler: _lazy_tboQFb, lazy: true, middleware: false, method: "post" },
  { route: '/api/security', handler: _lazy_pj9sNu, lazy: true, middleware: false, method: "get" },
  { route: '/', handler: _lazy_9m0S0k, lazy: true, middleware: false, method: undefined }
];
...
export { defineEventHandler as d, eventHandler as e, getRouterParam as g, handler as h, readBody as r, useRuntimeConfig as u };
